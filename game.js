...
HTMLActuator.prototype.addTile = function(tile) {
	...
	if (tile.previousPosition) {
		...
		var newPosClass = self.positionClass({
			x: tile.x,
			y: tile.y
		});
...
setItem: function(id, val) {
    return this._data[id] ? this._data[id] : (this._data[id] = String(val));
},
    ...
    return this._data.hasOwnProperty(id) ? delete this._data[id] : undefined;
},
